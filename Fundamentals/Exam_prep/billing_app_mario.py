...
class BillApp:
    def __init__(self, root):
        ...
        hair_shampoo_txt = Entry(F2, width=10, textvariable=self.hair_shampoo, font=('times new roman', 16, 'bold'),
                                 bd=5,
                                 relief=GROOVE)
        ...
        mineral_water_lbl_txt = Entry(F4, width=10, textvariable=self.mineral_water,
